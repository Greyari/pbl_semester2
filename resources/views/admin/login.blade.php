...
<body class="min-h-screen bg-gray-500 flex items-center justify-center">
    <div class="w-full max-w-md">
        <div class="bg-white shadow-lg rounded-lg px-10 pt-8 pb-10">
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="shadow-sm appearance-none border border-blue-700 rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-gray-100 focus:shadow-lg focus:ring-2 focus:ring-gray-400 focus:border-transparent">
                    @error('email')
                ...
                <div class="mb-4">
                    ...
                    <input id="no_hp" type="text" name="no_hp" value="{{ old('no_hp') }}" required class="shadow-sm appearance-none border border-blue-700 rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-gray-100 focus:shadow-lg focus:ring-2 focus:ring-gray-400 focus:border-transparent">
                    @error('no_hp')
                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                    @enderror
                </div>
